========================================================================
    ACTIVE TEMPLATE LIBRARY : DVCPlugin Project Overview
========================================================================

AppWizard has created this DVCPlugin project for you to use as the starting point for
...
DVCPlugin.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (DVCPlugin.h)
        GUID definitions                                (DVCPlugin_i.c)
        A type library                                  (DVCPlugin.tlb)
        Marshaling code                                 (DVCPlugin_p.c and dlldata.c)

DVCPlugin.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in DVCPlugin.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named DVCPlugin.pch and a precompiled types file named StdAfx.obj.
...
DVCPluginps.vcxproj
	...
	dlldata.c, DVCPlugin_i.c and DVCPlugin_p.c which are required
	to build the proxy/stub DLL.

DVCPluginps.vcxproj.filters
